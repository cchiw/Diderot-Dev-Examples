...
static void sample_init (sample_strand *self, int32_t p_R_0)
{
    ...
    float l_r_7 = 0.1e1f * 0.0f * 0.0f * 0.1e1f;
    float l_r_8 = 0.1e1f * 0.1e1f * 0.1e1f * 0.1e1f;
    self->sv_X[0] = _arg_6;
    self->sv_X[1] = _arg_5;
    self->sv_X[2] = _arg_4;
    self->sv_X[3] = _arg_3;
    self->sv_X[4] = _arg_2;
    self->sv_out = std::sqrt(l_r_7 + 0.3e1f * 0.1e1f * 0.1e1f * 0.3e1f + (l_r_8 + 0.3e1f * 0.0f * 0.0f * 0.3e1f)) + std::sqrt(
        0.9e1f * 0.0f * 0.0f * 0.9e1f + 0.7e1f * 0.1e1f * 0.1e1f * 0.7e1f + (0.9e1f * 0.1e1f * 0.1e1f * 0.9e1f + 0.7e1f * 0.0f * 0.0f * 0.7e1f)) + std::sqrt(
        0.8e1f * 0.0f * 0.0f * 0.8e1f + l__t_1 * 0.1e1f * 0.1e1f * l__t_1 + (0.8e1f * 0.1e1f * 0.1e1f * 0.8e1f + l__t_1 * 0.0f * 0.0f * l__t_1)) + std::sqrt(
        0.2e1f * 0.0f * 0.0f * 0.2e1f + l_r_8 + (0.2e1f * 0.1e1f * 0.1e1f * 0.2e1f + l_r_7)) + std::sqrt(
        l_r_7 + 0.6e1f * 0.1e1f * 0.1e1f * 0.6e1f + (l_r_8 + 0.6e1f * 0.0f * 0.0f * 0.6e1f));
}
static diderot::strand_status sample_update (sample_strand *self)
{
...
bool world::create_strands ()
{
    ...
    uint32_t ix = 0;
    for (int i_vi_9 = lo_0; i_vi_9 <= hi_1; i_vi_9++) {
        sample_init(this->_strands.strand(ix), i_vi_9);
        ++ix;
    }
    this->swap_state();
