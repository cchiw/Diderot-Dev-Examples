...
/*! \file X3.cxx
 *
 * Generated from X3.diderot.
 *
 * Command: /Users/chariseechiw/diderot/Diderot-Dev/bin/diderotc --exec X3.diderot
...
static std::string ProgramName = "X3";
...
{
    tensor_2 _arg_1 = {0.6e1f,0.1e1f,};
    tensor_2 _arg_2 = {0.1e1f,0.2e1f,};
    tensor_2 _arg_3 = {static_cast<float>(p_R_0),0.8e1f,};
    tensor_2 _arg_4 = {0.7e1f,0.9e1f,};
    tensor_2 _arg_5 = {0.3e1f,0.1e1f,};
    float l_r_6 = 0.1e1f * 0.1e1f * glob->gv__t;
    float l_r_7 = 0.0f * 0.0f * glob->gv__t;
    float l_r_8 = l_r_6 + l_r_7;
    float l_r_9 = 0.0f * 0.1e1f * glob->gv__t;
    float l_r_10 = 0.1e1f * 0.0f * glob->gv__t;
    float l_r_11 = l_r_9 + l_r_10;
    float l_r_12 = l_r_10 + l_r_9;
    float l_r_13 = l_r_7 + l_r_6;
    self->sv_X[0] = _arg_5;
    self->sv_X[1] = _arg_4;
    self->sv_X[2] = _arg_3;
    self->sv_X[3] = _arg_2;
    self->sv_X[4] = _arg_1;
    self->sv_out[0] = l_r_8 + l_r_8 + l_r_8 + l_r_8 + l_r_8;
    self->sv_out[1] = l_r_11 + l_r_11 + l_r_11 + l_r_11 + l_r_11;
    self->sv_out[2] = l_r_12 + l_r_12 + l_r_12 + l_r_12 + l_r_12;
    self->sv_out[3] = l_r_13 + l_r_13 + l_r_13 + l_r_13 + l_r_13;
}
static diderot::strand_status sample_update (sample_strand *self)
{
...
bool output_get_out (world *wrld, Nrrd *nData)
{
    ...
    for (auto ix = wrld->_strands.begin_alive(); ix != wrld->_strands.end_alive(); ix = wrld->_strands.next_alive(ix)) {
        memcpy(cp, &wrld->_strands.strand(ix)->sv_out, 4 * sizeof(float));
        cp += 4 * sizeof(float);
    }
...
bool world::create_strands ()
{
    ...
    uint32_t ix = 0;
    for (int i_vi_14 = lo_0; i_vi_14 <= hi_1; i_vi_14++) {
        sample_init(this->_globals, this->_strands.strand(ix), i_vi_14);
        ++ix;
    }
    this->swap_state();
