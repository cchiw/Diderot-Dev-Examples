/*---------- begin cxx-head.in ----------*/
/*! \file dfn_input_multi_X1.cxx
 *
 * Generated from dfn_input_multi_X1.diderot.
 *
 * Command: /Users/chariseechiw/diderot/Diderot-Dev/bin/diderotc --exec dfn_input_multi_X1.diderot
...
static std::string ProgramName = "dfn_input_multi_X1";
...
static void sample_init (sample_strand *self, int32_t p_i_0)
{
    self->sv_A = 0.5e1f;
    self->sv_out = 0.3e1f * 0.5e1f * 0.5e1f;
}
static diderot::strand_status sample_update (sample_strand *self)
{
...
bool world::create_strands ()
{
    ...
    uint32_t ix = 0;
    for (int i_vi_1 = lo_0; i_vi_1 <= hi_1; i_vi_1++) {
        sample_init(this->_strands.strand(ix), i_vi_1);
        ++ix;
    }
    this->swap_state();
