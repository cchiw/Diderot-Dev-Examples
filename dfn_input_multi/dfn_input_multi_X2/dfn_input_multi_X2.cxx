/*---------- begin cxx-head.in ----------*/
/*! \file dfn_input_multi_X2.cxx
 *
 * Generated from dfn_input_multi_X2.diderot.
 *
 * Command: /Users/chariseechiw/diderot/Diderot-Dev/bin/diderotc --exec dfn_input_multi_X2.diderot
...
static std::string ProgramName = "dfn_input_multi_X2";
...
static diderot::strand_status f_update (f_strand *self)
{
    self->sv_out = 0.2e1f * 0.3e1f - 0.1e1f;
...
bool world::create_strands ()
{
    ...
    uint32_t ix = 0;
    for (int i_i_1 = lo_0; i_i_1 <= hi_1; i_i_1++) {
        f_init(this->_strands.strand(ix), i_i_1);
        ++ix;
    }
    this->swap_state();
