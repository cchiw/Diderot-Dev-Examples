...
static void LIC_stabilize (globals *glob, LIC_strand *self)
{
    ...
    vec2 v_240 = v_239;
    vec3 v_241 = v_232;
    float l__t_242 = std::min(0.1e1f, std::sqrt(std::sqrt(vdot2(v_233, v_233)) / glob->gv_velomax));
    float l_op1_e3_l_22_243 = 0.0f + (self->sv_sum - l_op1_e3_l_14_234) / (0.2e1f * glob->gv_stdv - l_op1_e3_l_14_234) * (0.1e1f - 0.0f);
    ...
    vpack3(self->sv_rgb,
        v_241 + vscale3(l__t_242,
            vscale3(clamp(0.0f, 0.1e1f, l_op1_e3_l_22_243),
                vcons3(vdot2(vload2(l_voxels_246.last(0).addr(0)), v_240),
                    vdot2(vload2(l_voxels_246.last(2).addr(0)), v_240),
                    vdot2(vload2(l_voxels_246.last(4).addr(0)), v_240))) - v_241));
}
