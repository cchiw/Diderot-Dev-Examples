...
/*! \file mingrad1.cxx
 *
 * Generated from mingrad1.diderot.
 *
 * Command: /Users/chariseechiw/diderot/chiw17/bin/diderotc --exec mingrad1.diderot
...
static std::string ProgramName = "mingrad1";
...
static diderot::strand_status sample_update (globals *glob, sample_strand *self)
{
    ...
    if (inside2Ds3(v_12, glob->gv_promote_img0) && inside2Ds3(v_14, glob->gv_promote_img)) {
        ...
        if (glob->gv_obs == true) {
            ...
            vec2 v_88 = vcons2(
                vdot6(v_48,
                    vcons6(vdot6(v_87, v_28), vdot6(v_87, v_30), vdot6(v_87, v_32), vdot6(v_87, v_34),
                        vdot6(v_87, v_36), vdot6(v_87, v_38))),
            ...
            vec2 v_90 = vcons2(
                vdot6(v_77,
                    vcons6(vdot6(v_89, v_64), vdot6(v_89, v_66), vdot6(v_89, v_68), vdot6(v_89, v_70),
                        vdot6(v_89, v_72), vdot6(v_89, v_74))),
            ...
            vec2 v_190;
            vec2 v_93 = vfloor2(v_16);
            vec2 v_94 = v_16 - v_93;
            diderot::array< int32_t, 2 > l_n_95 = vtoi2(v_93);
            int32_t l_idx_96 = l_n_95[0] + -2;
            int32_t l_idx_97 = l_n_95[1] + -2;
            int32_t l_mulRes_98 = 70 * l_idx_97;
            int32_t l_addRes_99 = l_idx_96 + 1;
            int32_t l_addRes_100 = l_idx_96 + 2;
            int32_t l_addRes_101 = l_idx_96 + 3;
            int32_t l_addRes_102 = l_idx_96 + 4;
            int32_t l_addRes_103 = l_idx_96 + 5;
            vec6 v_104 = vcons6(glob->gv_promote_img[l_idx_96 + l_mulRes_98],
                glob->gv_promote_img[l_addRes_99 + l_mulRes_98], glob->gv_promote_img[l_addRes_100 + l_mulRes_98],
                glob->gv_promote_img[l_addRes_101 + l_mulRes_98], glob->gv_promote_img[l_addRes_102 + l_mulRes_98],
                glob->gv_promote_img[l_addRes_103 + l_mulRes_98]);
            int32_t l_mulRes_105 = 70 * (l_idx_97 + 1);
            vec6 v_106 = vcons6(glob->gv_promote_img[l_idx_96 + l_mulRes_105],
                glob->gv_promote_img[l_addRes_99 + l_mulRes_105], glob->gv_promote_img[l_addRes_100 + l_mulRes_105],
                glob->gv_promote_img[l_addRes_101 + l_mulRes_105], glob->gv_promote_img[l_addRes_102 + l_mulRes_105],
                glob->gv_promote_img[l_addRes_103 + l_mulRes_105]);
            int32_t l_mulRes_107 = 70 * (l_idx_97 + 2);
            vec6 v_108 = vcons6(glob->gv_promote_img[l_idx_96 + l_mulRes_107],
                glob->gv_promote_img[l_addRes_99 + l_mulRes_107], glob->gv_promote_img[l_addRes_100 + l_mulRes_107],
                glob->gv_promote_img[l_addRes_101 + l_mulRes_107], glob->gv_promote_img[l_addRes_102 + l_mulRes_107],
                glob->gv_promote_img[l_addRes_103 + l_mulRes_107]);
            int32_t l_mulRes_109 = 70 * (l_idx_97 + 3);
            vec6 v_110 = vcons6(glob->gv_promote_img[l_idx_96 + l_mulRes_109],
                glob->gv_promote_img[l_addRes_99 + l_mulRes_109], glob->gv_promote_img[l_addRes_100 + l_mulRes_109],
                glob->gv_promote_img[l_addRes_101 + l_mulRes_109], glob->gv_promote_img[l_addRes_102 + l_mulRes_109],
                glob->gv_promote_img[l_addRes_103 + l_mulRes_109]);
            int32_t l_mulRes_111 = 70 * (l_idx_97 + 4);
            vec6 v_112 = vcons6(glob->gv_promote_img[l_idx_96 + l_mulRes_111],
                glob->gv_promote_img[l_addRes_99 + l_mulRes_111], glob->gv_promote_img[l_addRes_100 + l_mulRes_111],
                glob->gv_promote_img[l_addRes_101 + l_mulRes_111], glob->gv_promote_img[l_addRes_102 + l_mulRes_111],
                glob->gv_promote_img[l_addRes_103 + l_mulRes_111]);
            int32_t l_mulRes_113 = 70 * (l_idx_97 + 5);
            vec6 v_114 = vcons6(glob->gv_promote_img[l_idx_96 + l_mulRes_113],
                glob->gv_promote_img[l_addRes_99 + l_mulRes_113], glob->gv_promote_img[l_addRes_100 + l_mulRes_113],
                glob->gv_promote_img[l_addRes_101 + l_mulRes_113], glob->gv_promote_img[l_addRes_102 + l_mulRes_113],
                glob->gv_promote_img[l_addRes_103 + l_mulRes_113]);
            float l_vY__115 = v_94[1];
            vec6 v_116 = vcons6(l_vY__115 + 0.2e1f, l_vY__115 + 0.1e1f, l_vY__115, l_vY__115 - 0.1e1f,
                l_vY__115 - 0.2e1f, l_vY__115 - 0.3e1f);
            vec6 v_117 = vcons6(0.961875e1f, 0.1875e-1f, 0.8625e0f, 0.8625e0f, 0.1875e-1f, 0.961875e1f);
            vec6 v_118 = vcons6(-0.23625e2f, 0.4375e1f, 0.0f, 0.0f, -0.4375e1f, 0.23625e2f);
            vec6 v_119 = vcons6(0.2334375e2f, -0.1065625e2f, -0.14375e1f, -0.14375e1f, -0.1065625e2f, 0.2334375e2f);
            vec6 v_120 = vcons6(-0.12e2f, 0.10e2f, 0.0f, 0.0f, -0.10e2f, 0.12e2f);
            vec6 v_121 = vcons6(0.340625e1f, -0.459375e1f, 0.11875e1f, 0.11875e1f, -0.459375e1f, 0.340625e1f);
            vec6 v_122 = vcons6(-0.508333333333e0f, 0.104166666667e1f, -0.583333333333e0f, 0.583333333333e0f,
                -0.104166666667e1f, 0.508333333333e0f);
            vec6 v_123 = vcons6(0.3125e-1f, -0.9375e-1f, 0.625e-1f, 0.625e-1f, -0.9375e-1f, 0.3125e-1f);
            vec6 v_124 = v_117 + v_116 * (v_118 + v_116 * (v_119 + v_116 * (v_120 + v_116 * (v_121 + v_116 * (v_122 + v_116 * v_123)))));
            float l_vX__125 = v_94[0];
            vec6 v_126 = vcons6(l_vX__125 + 0.2e1f, l_vX__125 + 0.1e1f, l_vX__125, l_vX__125 - 0.1e1f,
                l_vX__125 - 0.2e1f, l_vX__125 - 0.3e1f);
            vec6 v_127 = v_117 + v_126 * (v_118 + v_126 * (v_119 + v_126 * (v_120 + v_126 * (v_121 + v_126 * (v_122 + v_126 * v_123)))));
            vec6 v_128 = vcons6(vdot6(v_127, v_104), vdot6(v_127, v_106), vdot6(v_127, v_108), vdot6(v_127, v_110),
                vdot6(v_127, v_112), vdot6(v_127, v_114));
            vec2 v_129 = vfloor2(v_15);
            vec2 v_130 = v_15 - v_129;
            diderot::array< int32_t, 2 > l_n_131 = vtoi2(v_129);
            int32_t l_idx_132 = l_n_131[0] + -2;
            int32_t l_idx_133 = l_n_131[1] + -2;
            int32_t l_mulRes_134 = 70 * l_idx_133;
            int32_t l_addRes_135 = l_idx_132 + 1;
            int32_t l_addRes_136 = l_idx_132 + 2;
            int32_t l_addRes_137 = l_idx_132 + 3;
            int32_t l_addRes_138 = l_idx_132 + 4;
            int32_t l_addRes_139 = l_idx_132 + 5;
            vec6 v_140 = vcons6(glob->gv_promote_img0[l_idx_132 + l_mulRes_134],
                glob->gv_promote_img0[l_addRes_135 + l_mulRes_134], glob->gv_promote_img0[l_addRes_136 + l_mulRes_134],
                glob->gv_promote_img0[l_addRes_137 + l_mulRes_134], glob->gv_promote_img0[l_addRes_138 + l_mulRes_134],
                glob->gv_promote_img0[l_addRes_139 + l_mulRes_134]);
            int32_t l_mulRes_141 = 70 * (l_idx_133 + 1);
            vec6 v_142 = vcons6(glob->gv_promote_img0[l_idx_132 + l_mulRes_141],
                glob->gv_promote_img0[l_addRes_135 + l_mulRes_141], glob->gv_promote_img0[l_addRes_136 + l_mulRes_141],
                glob->gv_promote_img0[l_addRes_137 + l_mulRes_141], glob->gv_promote_img0[l_addRes_138 + l_mulRes_141],
                glob->gv_promote_img0[l_addRes_139 + l_mulRes_141]);
            int32_t l_mulRes_143 = 70 * (l_idx_133 + 2);
            vec6 v_144 = vcons6(glob->gv_promote_img0[l_idx_132 + l_mulRes_143],
                glob->gv_promote_img0[l_addRes_135 + l_mulRes_143], glob->gv_promote_img0[l_addRes_136 + l_mulRes_143],
                glob->gv_promote_img0[l_addRes_137 + l_mulRes_143], glob->gv_promote_img0[l_addRes_138 + l_mulRes_143],
                glob->gv_promote_img0[l_addRes_139 + l_mulRes_143]);
            int32_t l_mulRes_145 = 70 * (l_idx_133 + 3);
            vec6 v_146 = vcons6(glob->gv_promote_img0[l_idx_132 + l_mulRes_145],
                glob->gv_promote_img0[l_addRes_135 + l_mulRes_145], glob->gv_promote_img0[l_addRes_136 + l_mulRes_145],
                glob->gv_promote_img0[l_addRes_137 + l_mulRes_145], glob->gv_promote_img0[l_addRes_138 + l_mulRes_145],
                glob->gv_promote_img0[l_addRes_139 + l_mulRes_145]);
            int32_t l_mulRes_147 = 70 * (l_idx_133 + 4);
            vec6 v_148 = vcons6(glob->gv_promote_img0[l_idx_132 + l_mulRes_147],
                glob->gv_promote_img0[l_addRes_135 + l_mulRes_147], glob->gv_promote_img0[l_addRes_136 + l_mulRes_147],
                glob->gv_promote_img0[l_addRes_137 + l_mulRes_147], glob->gv_promote_img0[l_addRes_138 + l_mulRes_147],
                glob->gv_promote_img0[l_addRes_139 + l_mulRes_147]);
            int32_t l_mulRes_149 = 70 * (l_idx_133 + 5);
            vec6 v_150 = vcons6(glob->gv_promote_img0[l_idx_132 + l_mulRes_149],
                glob->gv_promote_img0[l_addRes_135 + l_mulRes_149], glob->gv_promote_img0[l_addRes_136 + l_mulRes_149],
                glob->gv_promote_img0[l_addRes_137 + l_mulRes_149], glob->gv_promote_img0[l_addRes_138 + l_mulRes_149],
                glob->gv_promote_img0[l_addRes_139 + l_mulRes_149]);
            float l_vY__151 = v_130[1];
            vec6 v_152 = vcons6(l_vY__151 + 0.2e1f, l_vY__151 + 0.1e1f, l_vY__151, l_vY__151 - 0.1e1f,
                l_vY__151 - 0.2e1f, l_vY__151 - 0.3e1f);
            vec6 v_153 = v_117 + v_152 * (v_118 + v_152 * (v_119 + v_152 * (v_120 + v_152 * (v_121 + v_152 * (v_122 + v_152 * v_123)))));
            float l_vX__154 = v_130[0];
            vec6 v_155 = vcons6(l_vX__154 + 0.2e1f, l_vX__154 + 0.1e1f, l_vX__154, l_vX__154 - 0.1e1f,
                l_vX__154 - 0.2e1f, l_vX__154 - 0.3e1f);
            vec6 v_156 = v_117 + v_155 * (v_118 + v_155 * (v_119 + v_155 * (v_120 + v_155 * (v_121 + v_155 * (v_122 + v_155 * v_123)))));
            vec6 v_157 = vcons6(vdot6(v_156, v_140), vdot6(v_156, v_142), vdot6(v_156, v_144), vdot6(v_156, v_146),
                vdot6(v_156, v_148), vdot6(v_156, v_150));
            vec6 v_158 = v_128;
            vec6 v_159 = v_152;
            vec6 v_160 = v_104;
            vec2 v_161 = vcons2(l_Mtransform_11[0], l_Mtransform_11[2]);
            vec2 v_162 = vcons2(l_Mtransform_11[1], l_Mtransform_11[3]);
            vec6 v_163 = v_153;
            vec6 v_164 = v_106;
            vec6 v_165 = v_108;
            vec6 v_166 = v_157;
            ...
            vec6 v_177 = v_155;
            vec6 v_178 = v_116;
            vec2 v_179 = vcons2(l_Mtransform_13[0], l_Mtransform_13[2]);
            vec2 v_180 = vcons2(l_Mtransform_13[1], l_Mtransform_13[3]);
            vec6 v_181 = v_124;
            vec6 v_182 = v_118;
            if (vdot6(v_124, v_128) < vdot6(v_153, v_157)) {
                vec6 v_183 = vcons6(0.466875e2f, -0.213125e2f, -0.2875e1f, -0.2875e1f, -0.213125e2f, 0.466875e2f);
                vec6 v_184 = vcons6(-0.36e2f, 0.30e2f, 0.0f, 0.0f, -0.30e2f, 0.36e2f);
                vec6 v_185 = vcons6(0.13625e2f, -0.18375e2f, 0.475e1f, 0.475e1f, -0.18375e2f, 0.13625e2f);
                vec6 v_186 = vcons6(-0.254166666667e1f, 0.520833333333e1f, -0.291666666667e1f, 0.291666666667e1f,
                    -0.520833333333e1f, 0.254166666667e1f);
                vec6 v_187 = vcons6(0.1875e0f, -0.5625e0f, 0.375e0f, 0.375e0f, -0.5625e0f, 0.1875e0f);
                vec6 v_188 = v_182 + v_172 * (v_183 + v_172 * (v_184 + v_172 * (v_185 + v_172 * (v_186 + v_172 * v_187))));
                vec2 v_189 = vcons2(
                    vdot6(v_181,
                        vcons6(vdot6(v_188, v_160), vdot6(v_188, v_164), vdot6(v_188, v_165), vdot6(v_188, v_167),
                            vdot6(v_188, v_169), vdot6(v_188, v_171))),
                    vdot6(
                        v_182 + v_178 * (v_183 + v_178 * (v_184 + v_178 * (v_185 + v_178 * (v_186 + v_178 * v_187)))),
                        v_158));
                v_190 = vcons2(vdot2(v_189, v_179), vdot2(v_189, v_180));
            }
            else {
                vec6 v_191 = vcons6(0.466875e2f, -0.213125e2f, -0.2875e1f, -0.2875e1f, -0.213125e2f, 0.466875e2f);
                vec6 v_192 = vcons6(-0.36e2f, 0.30e2f, 0.0f, 0.0f, -0.30e2f, 0.36e2f);
                vec6 v_193 = vcons6(0.13625e2f, -0.18375e2f, 0.475e1f, 0.475e1f, -0.18375e2f, 0.13625e2f);
                vec6 v_194 = vcons6(-0.254166666667e1f, 0.520833333333e1f, -0.291666666667e1f, 0.291666666667e1f,
                    -0.520833333333e1f, 0.254166666667e1f);
                vec6 v_195 = vcons6(0.1875e0f, -0.5625e0f, 0.375e0f, 0.375e0f, -0.5625e0f, 0.1875e0f);
                vec6 v_196 = v_182 + v_177 * (v_191 + v_177 * (v_192 + v_177 * (v_193 + v_177 * (v_194 + v_177 * v_195))));
                vec2 v_197 = vcons2(
                    vdot6(v_163,
                        vcons6(vdot6(v_196, v_168), vdot6(v_196, v_170), vdot6(v_196, v_173), vdot6(v_196, v_174),
                            vdot6(v_196, v_175), vdot6(v_196, v_176))),
                    vdot6(
                        v_182 + v_159 * (v_191 + v_159 * (v_192 + v_159 * (v_193 + v_159 * (v_194 + v_159 * v_195)))),
                        v_166));
                v_190 = vcons2(vdot2(v_197, v_161), vdot2(v_197, v_162));
            }
            v_92 = v_190;
        }
        v_198 = v_92;
        ...
        v_198 = vload2(tensor_ref_2(self->sv_out).addr(0));
    }
    vpack2(self->sv_pos, v_6);
    vpack2(self->sv_out, v_198);
...
bool world::create_strands ()
{
    ...
    uint32_t ix = 0;
    for (int i_i_201 = lo_0; i_i_201 <= hi_1; i_i_201++) {
        sample_init(this->_strands.strand(ix), i_i_201);
        ++ix;
    }
    this->swap_state();
